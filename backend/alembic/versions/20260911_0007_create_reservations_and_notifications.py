...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["book_id"],
            ["books.id"],
            name="fk_book_reservations_book_id_books",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name="fk_book_reservations_user_id_users",
            ondelete="RESTRICT",
        ),
    ...
    op.create_index(
        ...
        "book_reservations",
        ["book_id", "created_at_timestamp", "id"],
    ...
    op.create_index(
        "ix_book_reservations_book_status", "book_reservations", ["book_id", "status"]
    )
